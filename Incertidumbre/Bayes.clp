...
(efecto test Covid)         ; fiebre es un efecto o síntoma común de Padulismo
...
(probcond2 Covid SI zona_origen alto_riesgo vacuna si 0.001)
(probcond2 Covid SI zona_origen alto_riesgo vacuna no 0.005)
(probcond2 Covid SI zona_origen medio_riesgo vacuna si 0.005)
(probcond2 Covid SI zona_origen medio_riesgo vacuna no 0.1)
(probcond2 Covid SI zona_origen bajo_riesgo vacuna si 0.1)
(probcond2 Covid SI zona_origen bajo_riesgo vacuna no 0.3)
)

(deffacts probabilidad_efectos
(probcond fiebre alta si Covid SI 0.7)
(probcond fiebre alta si Covid NO 0.3)
(probcond fiebre moderada si Covid SI 0.3)
(probcond fiebre moderada si Covid NO 0.6)
(probcond fiebre baja si Covid SI 0.1)
(probcond fiebre baja si Covid NO 0.8)
(probcond tos si Covid SI 0.8)
(probcond tos si Covid NO 0.2)
(probcond tos no Covid SI 0.1)
(probcond tos no Covid NO 0.9)
...
(red causal causas)
=>
(printout t "Escribe una opcion: Tiene usted la vacuna?(1=si 2=no 3=Desconocido): " )
(bind ?respuesta (read))
...
(red causal causas)
=>
(printout t "Escribe una opcion: Presenta usted tos?(1=si 2=no 3=Desconocido): " )
(bind ?respuesta (read))
...
(red causal causas)
=>
(printout t "Escribe una opcion: Ha realizado un test?(1=si 2=no): " )
(bind ?respuesta (read))
(printout t crlf)
(if (= ?respuesta 1) then
    (printout t "Que resultado obtuvo en ese test? (1=positivo,2=negativo)")
    (bind ?respuesta (read) )
