...
;; Añado la verificación de edad antes de argumentar la dosis
;; Tal que si es un crio que el máximo sea un dosis media
...
(cd temperatura alta 37.8 38.5 39.2 39.5)  ; aproximadamente mas 38.5
(cd temperatura muy_alta 39 39.5 100 100)  ; aproximadamente mas 39.5
(cd peso bajo 0 0 40 50)     ; aproximadamente  menos de 40
(cd peso medio 50 60 75 80)  ; aproximadamente entre 60 y 75
(cd peso alto 80 90 300 300) ; aproximadamente mas de 90
...
(cd dosis muy_alta 10 12 14 15) ; aproximadaament 13
(cd edad crio 0 0 16 17) ; aproximadamente menos de 17;
(cd edad adulto 17 18 120 120) ; aproximadamente menos de 17;
)
...
(regla 1 explicacion "Dado que la temperatura es normal, la dosis a aplicar es cero")
(regla 2 antecedente temperatura destemplada)
(regla 2 antecedente peso medio)
(regla 2 consecuente dosis media)
(regla 2 explicacion "Dado que esta destemplado y el peso es medio, la dosis a aplicar es media")
(regla 2bis antecedente temperatura destemplada)
(regla 2bis antecedente peso alto)
(regla 2bis consecuente dosis media)
(regla 2bis explicacion "Dado que esta destemplado y el peso es alto, la dosis a aplicar es media")
(regla 3 antecedente temperatura destemplada)
(regla 3 antecedente peso bajo)
(regla 3 consecuente dosis baja)
(regla 3 explicacion "Dado que esta destemplado y el peso es bajo, la dosis a aplicar es baja")
(regla 4 antecedente temperatura alta)
(regla 4 consecuente dosis alta)
(regla 4 explicacion "Dado que la temperatura es alta, la dosis a aplicar es alta")
(regla 5 antecedente temperatura muy_alta)
(regla 5 consecuente dosis muy_alta)
(regla 5 explicacion "Dado que la temperatura es muy alta, la dosis a aplicar es muy alta")
(regla 6 antecedente edad crio)
(regla 6 antecedente temperatura alta)
(regla 6 consecuente dosis media)
(regla 6 explicacion "Al ser menor de edad con esa temperatura, la dosis es media")
)
...
(printout t "El valor de " ?v " es " (/ ?n ?d)  " ml"crlf)
)
...
(declare (salience 1))
=>
(printout t "Cuál es la temperatura del paciente? ")
